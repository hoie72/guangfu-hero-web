    ...
    <div className="min-h-screen flex flex-col bg-white dark:bg-gray-900">
      ...
      <main className="flex-1 pb-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <h1 className="text-3xl font-bold mb-8 dark:text-white">服務條款</h1>
          ...
          <div className="space-y-6 text-gray-700 dark:text-gray-300">
            ...
            <section>
              <h2 className="text-xl font-bold mb-3 dark:text-white">本平台提供以下服務</h2>
              <ul className="list-disc pl-6 space-y-2">
                <li>救災志工報名與媒合資訊</li>
            ...
            <section>
              <h2 className="text-xl font-bold mb-3 dark:text-white">本平台性質與免責</h2>
              <ul className="list-disc pl-6 space-y-2">
              ...
              <h3 className="text-lg font-bold mt-4 mb-2 dark:text-gray-100">資訊正確性</h3>
            ...
            <section>
              <h2 className="text-xl font-bold mb-3 dark:text-white">物資捐贈媒合服務</h2>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section>
              <h2 className="text-xl font-bold mb-3 dark:text-white">授權</h2>

              <h3 className="text-lg font-bold mt-4 mb-2 dark:text-gray-100">使用者內容規範</h3>
              ...
              <h3 className="text-lg font-bold mt-4 mb-2 dark:text-gray-100">智慧財產權</h3>
              <p className="mb-2">本平台之所有內容，包括但不限於文字、圖片、影音、軟體、程式碼、網站架構、網頁設計等，均受著作權法及其他智慧財產權法保護。</p>

              <h3 className="text-lg font-bold mt-4 mb-2 dark:text-gray-100">使用者授權</h3>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section>
              <h2 className="text-xl font-bold mb-3 dark:text-white">第三方服務</h2>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section>
              <h2 className="text-xl font-bold mb-3 dark:text-white">服務變更與終止</h2>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section>
              <h2 className="text-xl font-bold mb-3 dark:text-white">準據法與管轄</h2>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section>
              <h2 className="text-xl font-bold mb-3 dark:text-white">資料移除與更正</h2>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section className="bg-gray-100 dark:bg-gray-800 p-4 rounded mt-8">
              <p className="font-bold dark:text-white">本服務條款自公告日起生效</p>
